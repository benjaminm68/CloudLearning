    ...
    var $addCollectionButton = $('<button class="btn btn-warning btn-sm btn-module" type="button" class="add_collection_link">Ajouter Module</button>');
    var $delCollectionButton = $('<button class="btn btn-danger btn-sm btn-module" type="button" class="del_collection_link">Supprimer</button>');
    ...
    $(document).ready(function() {
        ...
        var $collection = $("ul#gestionStagiaire")
